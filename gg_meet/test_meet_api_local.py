...
def run_mock_test():
    ...
    mock_participants = [
        {"name": f"{mock_conf_record['name']}/participants/p001", "signedinUser": {"user": "users/kim-yujin", "displayName": "김유진 팀장 (코웨이)"}, "earliestStartTime": "2026-08-18T15:03:00Z"},
    ...
    mock_entries = [
        {"name": f"{mock_transcript['name']}/entries/e001", "participant": "김유진 팀장 (코웨이)", "startTime": "00:00:00", "text": "어 회의 성격에 맞는 어떤 회의록 포맷을 사전에 정리하고 그걸 기반으로 회의록을 작성하고자 합니다.", "languageCode": "ko-KR"},
