...
def run_mock_test():
    ...
    mock_participants = [
        {"name": f"{mock_conf_record['name']}/participants/p001", "signedinUser": {"user": "users/hong-gildong", "displayName": "홍길동 팀장 (리테일 회사)"}, "earliestStartTime": "2026-08-18T15:03:00Z"},
        {"name": f"{mock_conf_record['name']}/participants/p002", "signedinUser": {"user": "users/lee-mongryong", "displayName": "이몽룡 담당 (리테일 회사)"}, "earliestStartTime": "2026-08-18T15:03:02Z"},
        {"name": f"{mock_conf_record['name']}/participants/p003", "signedinUser": {"user": "users/sung-chunhyang", "displayName": "성춘향 님 (리테일 회사)"}, "earliestStartTime": "2026-08-18T15:03:05Z"},
        {"name": f"{mock_conf_record['name']}/participants/p004", "signedinUser": {"user": "users/google-ce", "displayName": "담당 CE (Google Cloud)"}, "earliestStartTime": "2026-08-18T15:03:00Z"},
    ]
    ...
    mock_transcript = {
        ...
        "state": "FILE_GENERATED",
        "docsDestination": {
            "document": "1Doc_Meet_Transcript_Enterprise_Tech_20260818",
            "exportUri": "https://docs.google.com/document/d/1Doc_Meet_Transcript_Enterprise_Tech_20260818/edit"
        }
    }
    mock_entries = [
        ...
        {"name": f"{mock_transcript['name']}/entries/e002", "participant": "담당 CE (Google Cloud)", "startTime": "00:00:15", "text": "네, Vertex AI Gemini 3.7 Flash 모델의 멀티모달 오디오 처리 파이프라인을 통해 화자 분리와 회의록 작성이 가능합니다.", "languageCode": "ko-KR"},
        {"name": f"{mock_transcript['name']}/entries/e003", "participant": "이몽룡 담당 (리테일 회사)", "startTime": "00:00:35", "text": "보안 관점에서 회의 녹화 파일의 임시 저장소 라이프사이클 정책도 중요할 것 같습니다.", "languageCode": "ko-KR"},
    ]
